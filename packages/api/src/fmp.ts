...
export class FMP {
  ...
  public readonly analyst: AnalystEndpoints;
  public readonly valuation: ValuationEndpoints;
  public readonly technical: TechnicalEndpoints;
  ...
  constructor(config: FMPConfig = {}) {
    ...
    this.analyst = new AnalystEndpoints(client);
    this.valuation = new ValuationEndpoints(client);
    this.technical = new TechnicalEndpoints(client);
