...
<ApiTable
  endpoints={[
    ...
    },
    {
      method: 'GET',
      path: '/forex/*',
      description: 'Foreign exchange endpoints for currency rates and forex-specific data',
    },
    {
      method: 'GET',
      path: '/crypto/*',
      description: 'Cryptocurrency endpoints for crypto-specific data',
    },
    {
      method: 'GET',
      path: '/etf/*',
...
Access forex-specific data:

- **Forex Rates** - Real-time forex rates and currency data
- **Currency Pairs** - Major and minor currency pairs
- **Forex-specific Data** - Forex-specific market information

[View Forex Endpoints →](/docs/api/forex)

### Crypto Endpoints

Access cryptocurrency-specific data:

- **Crypto List** - Available cryptocurrencies
- **Crypto-specific Data** - Cryptocurrency-specific market information
