  ...
  endpoints={[
    {
      ...
      path: '/stock/*',
      description:
        'Stock-related endpoints for quotes, historical data, and market information',
    },
    {
      method: 'GET',
      path: '/financial/*',
    ...
    },
    {
      ...
      path: '/forex/*',
      description:
        'Foreign exchange endpoints for currency quotes and historical data',
    },
    {
      method: 'GET',
      path: '/crypto/*',
      description:
        'Cryptocurrency endpoints for crypto quotes and historical data',
    },
    {
      method: 'GET',
      path: '/etf/*',
      description:
        'ETF endpoints for quotes, profiles, and holdings data',
    },
    {
      method: 'GET',
      path: '/market/*',
      description:
        'Market endpoints for performance, hours, and sector data',
    },
    {
      method: 'GET',
      path: '/economic/*',
      description:
        'Economic indicators and calendar data',
    },
    {
      method: 'GET',
      path: '/bond/*',
      description:
        'Bond data and treasury rates',
    },
    {
      method: 'GET',
      path: '/mutual-fund/*',
      description:
        'Mutual fund quotes and data',
    },
  ]}
/>
