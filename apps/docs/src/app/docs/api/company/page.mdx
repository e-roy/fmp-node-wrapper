...
<ApiTable
  endpoints={[
    ...
    {
      method: 'GET',
      path: 'stable/stock-peers?symbol={symbol}',
      description: 'Get peer companies with price and market cap',
    },
  ]}
/>
    ...
    data: [
      {
        ...
        stockAward: 50000000,
        optionAward: 0,
        incentivePlanCompensation: 0,
        allOtherCompensation: 0,
        total: 53000000,
        link: 'https://www.sec.gov/Archives/edgar/data/320193/000032019324000006/aap-20231230.htm'
      }
    ]
}`}
</CodeBlock>
    ...
    data: [
      {
        ...
        price: 388.83,
        mktCap: 4702848416027
      },
      {
        symbol: 'MSFT',
        companyName: 'Microsoft Corporation',
        price: 430.16,
        mktCap: 3198000000000
      }
    ]
}`}
</CodeBlock>
...
console.log('Market Cap:', profile.data.marketCap);
