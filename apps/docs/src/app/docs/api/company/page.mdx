...
<CodeBlock language="typescript">
  {`const compensation = await fmp.company.getExecutiveCompensation({ symbol: 'AAPL' });`}
</CodeBlock>
...
<CodeBlock language="typescript">
  {`const notes = await fmp.company.getCompanyNotes({ symbol: 'AAPL' });`}
</CodeBlock>
...
<CodeBlock language="typescript">
  {`const employeeData = await fmp.company.getHistoricalEmployeeCount({ symbol: 'AAPL' });`}
</CodeBlock>
...
<CodeBlock language="typescript">
  {`const sharesFloat = await fmp.company.getSharesFloat({ symbol: 'AAPL' });`}
</CodeBlock>
...
<CodeBlock language="typescript">
  {`const historicalSharesFloat = await fmp.company.getHistoricalSharesFloat({ symbol: 'AAPL' });`}
</CodeBlock>
...
<CodeBlock language="typescript">
  {`const transcriptData = await fmp.company.getCompanyTranscriptData({ symbol: 'AAPL' });`}
</CodeBlock>
...
const [profile, compensation, employeeData, sharesFloat, transcriptData] = await Promise.all([
  fmp.company.getCompanyProfile({ symbol: 'AAPL' }),
  fmp.company.getExecutiveCompensation({ symbol: 'AAPL' }),
  fmp.company.getHistoricalEmployeeCount({ symbol: 'AAPL' }),
  fmp.company.getSharesFloat({ symbol: 'AAPL' }),
  fmp.company.getCompanyTranscriptData({ symbol: 'AAPL' })
]);
...
const [historicalEmployees, historicalShares] = await Promise.all([
  fmp.company.getHistoricalEmployeeCount({ symbol: 'AAPL' }),
  fmp.company.getHistoricalSharesFloat({ symbol: 'AAPL' })
]);
