...
<CodeBlock language="typescript">
  {`const holdingDates = await fmp.etf.getHoldingDates({ symbol: 'SPY' });`}
</CodeBlock>
...
<CodeBlock language="typescript">
  {`const holder = await fmp.etf.getHolder({ symbol: 'SPY' });`}
</CodeBlock>
...
<CodeBlock language="typescript">
  {`const sectorWeighting = await fmp.etf.getSectorWeighting({ symbol: 'SPY' });`}
</CodeBlock>
...
<CodeBlock language="typescript">
  {`const countryWeighting = await fmp.etf.getCountryWeighting({ symbol: 'SPY' });`}
</CodeBlock>
...
<CodeBlock language="typescript">
  {`const stockExposure = await fmp.etf.getStockExposure({ symbol: 'AAPL' });`}
</CodeBlock>
...
<CodeBlock language="typescript">
{`const profile = await fmp.etf.getProfile({ symbol: 'INVALID' });
