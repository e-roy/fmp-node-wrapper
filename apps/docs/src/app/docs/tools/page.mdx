...
<CodeBlock language="bash">{`npm install fmp-tools`}</CodeBlock>

<CodeBlock language="bash">{`pnpm add fmp-tools`}</CodeBlock>

<CodeBlock language="bash">{`yarn add fmp-tools`}</CodeBlock>
